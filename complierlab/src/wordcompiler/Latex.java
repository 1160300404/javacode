...
public class Latex
{
				...
				for(int i = 0; i < strline.length; i++) 
				{
                    ...
                    {  
                        ...
                        {  
                            ...
                            tableModel1.addRow(new Object[] {token, "<IDN,"+token+">","标识符"});
                            jtable1.invalidate();
                        }
                        token = "";
                    }
					...
					else if(isDigit(ch))
					{
                        ...
                        while ( (ch != '\0') && (isDigit(ch) || ch == '.' || ch == 'e' || ch == '-'))
                        {
                            ...
                            {  
                                ...
                                if (ch != '#' && true == digitDFA(ch, dfastr[k])) 
                                {  
                                    token += ch;  
                                    state = k;  
                                    break;  
                        ...
                        {  
                            if (((!isOp(ch)&&(!isbordar(ch)) )|| ch == '.') && !isDigit(ch)&&!(ch != '\0') )  
                                haveMistake = true;  
                        }  
  ...
  public static Boolean isbordar(char ch){
	...
	public static boolean digitDFA(char ch, char test) 
	{  
        if (test == 'd') {  
            if (isDigit(ch))  
                return true;  
